        ...
        <section className="mb-16">
          <div className="bg-slate-800 rounded-2xl p-8">
            ...
            <p className="text-slate-300 leading-relaxed">
              ...
              didirikan untuk menjawab kebutuhan tenaga profesional
              di bidang teknologi informasi dan komputer. Seiring
              perkembangan teknologi digital, program studi ini terus
              mengembangkan kurikulum yang relevan dengan kebutuhan
              industri serta mendorong inovasi melalui pendidikan,
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-slate-800 rounded-2xl p-8">
            ...
            <p className="text-slate-300">
              Menjadi program studi unggul dalam bidang teknologi
              informasi yang menghasilkan lulusan kompeten,
          ...
          <div className="bg-slate-800 rounded-2xl p-8">
            ...
            <ul className="list-disc list-inside text-slate-300 space-y-2">
              ...
              <li>Menghasilkan lulusan yang profesional dan berintegritas.</li>
            </ul>
          </div>
